...
<template>
    <DropDown>
        <template #trigger>
            <button class="text-heading bg-neutral-primary box-border border border-transparent hover:bg-neutral-secondary-medium focus:ring-4 focus:ring-neutral-tertiary font-medium leading-5 rounded-base text-sm p-2 focus:outline-none"
                type="button">
        ...
        <template #content>
            <div class="bg-neutral-primary-medium border border-default-medium rounded-base shadow-lg w-44">
                <ul class="p-2 text-sm text-body w-content font-medium" aria-labelledby="dropdownMenuIconButton">
                    <li>
